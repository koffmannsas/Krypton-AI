    ...
    <div className="bg-[#0B0B0F] min-h-screen pb-40">
      ...
      <section className="relative pt-40 pb-20 px-6 lg:px-20 overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full pointer-events-none">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-[#E10600]/10 blur-[120px] rounded-full"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <motion.div
            ...
            className="space-y-8"
          >
            <div className="inline-flex items-center gap-3 px-4 py-2 border border-[#E10600]/30 bg-[#E10600]/5 rounded-sm">
            ...
            <h1 className="text-6xl lg:text-9xl font-black tracking-tighter uppercase leading-[0.85] text-white">
              NOS <span className="text-[#E10600] italic">AGENTS</span> <br />
              D'ÉLITE.
            </h1>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white/5 border border-white/10 p-8 lg:p-12 rounded-sm relative overflow-hidden group">
            <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity">
              <BrainCircuit size={120} className="text-[#E10600]" />
            </div>
            ...
            <div className="relative z-10 space-y-8">
              ...
              <div className="relative">
                <textarea
                  ...
                  className="w-full bg-black/40 border border-white/10 p-6 text-white text-xl lg:text-2xl outline-none focus:border-[#E10600]/50 transition-all min-h-[120px] resize-none"
                />
                ...
                <div className="absolute bottom-4 right-4 flex items-center gap-4">
                  <AnimatePresence>
                    {isAssembling && (
                      <motion.div
                        ...
                        exit={{ opacity: 0, x: 10 }}
                        className="flex items-center gap-2 text-[#E10600]"
                      >
                  ...
                  <button
                    ...
                    className="bg-[#E10600] hover:bg-red-700 disabled:opacity-50 disabled:hover:bg-[#E10600] text-white px-8 py-4 font-black text-[10px] uppercase tracking-[0.2em] transition-all flex items-center gap-3 group"
                  >
              ...
              >
                <div className="lg:col-span-2 bg-white/5 border border-white/10 p-10 space-y-8">
                  <div className="space-y-4">
                    <div className="text-[#E10600] text-[10px] font-black uppercase tracking-[0.4em]">
                      {brief.sector}
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8 border-t border-white/5">
                    <div className="space-y-4">
                      <h4 className="text-xs font-black uppercase tracking-widest text-white flex items-center gap-2">
                        <Target size={14} className="text-[#E10600]" />
                        Défis Identifiés
                      </h4>
                ...
                <div
                  className="bg-[#E10600] p-10 flex flex-col justify-between group cursor-pointer"
                  onClick={onOpenFiko}
                >
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
            <div className="space-y-4">
              <h2 className="text-4xl lg:text-6xl font-black uppercase tracking-tighter text-white">
                L'ARSENAL <span className="text-[#E10600]">KRYPTON</span>
              </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {MASTER_AGENTS.map((agent, i) => (
              <motion.div
                ...
                className="group relative bg-black border border-white/5 hover:border-[#E10600]/30 transition-all duration-500 overflow-hidden"
              >
                ...
                <div className="relative z-10 p-8 h-full flex flex-col justify-between min-h-[400px]">
                  <div className="space-y-6">
                    <div className="flex items-start justify-between">
                      <div className="space-y-1">
                        <div className="text-[#E10600] text-[8px] font-black uppercase tracking-[0.4em]">
                          {agent.category}
                        </div>
                  ...
                  <div className="space-y-6 pt-8">
                    <div className="flex items-center gap-6 text-[9px] font-bold text-slate-500 uppercase tracking-widest">
                      ...
                      <div className="flex items-center gap-2">
                        <Network size={12} className="text-[#E10600]" />
                        Neural Sync
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <button
                        onClick={onOpenFiko}
                        className="flex items-center justify-center gap-2 bg-[#E10600]/10 border border-[#E10600]/20 hover:bg-[#E10600] text-[#E10600] hover:text-white transition-all py-3 text-[9px] font-black uppercase tracking-widest"
                      >
                        <Zap size={14} />
                        Déployer
                      </button>
                ...
                {/* Hover Border Effect */}
                <div className="absolute bottom-0 left-0 h-[2px] bg-[#E10600] transition-all duration-500 w-0 group-hover:w-full"></div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="mt-40 px-6 lg:px-20">
        <div className="max-w-4xl mx-auto text-center space-y-12">
          ...
          <h2 className="text-5xl lg:text-7xl font-black tracking-tighter uppercase text-white leading-none">
            ...
            <span className="text-[#E10600]">PRÊTE AU COMBAT.</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-8">
            <button
              onClick={onOpenFiko}
              className="w-full sm:w-auto bg-white text-black px-12 py-5 font-black text-[11px] uppercase tracking-[0.3em] hover:bg-[#E10600] hover:text-white transition-all shadow-2xl shadow-white/5"
            >
              Démarrer maintenant
            </button>
            <button
