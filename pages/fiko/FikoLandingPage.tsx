...
const FikoLandingPage: React.FC<FikoLandingPageProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-[#E10600] selection:text-white relative overflow-hidden">
      {/* URGENCY BANNER */}
      <div className="bg-[#E10600] text-white text-center py-3 px-4 font-black text-[10px] md:text-xs uppercase tracking-[0.4em] z-[100] relative shadow-2xl">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-[#E10600]/5 blur-[150px] rounded-full opacity-30"></div>
        <div className="absolute bottom-0 right-1/4 w-[800px] h-[800px] bg-[#E10600]/5 blur-[200px] rounded-full opacity-20"></div>
        ...
        {showChatBubble && (
          ...
          >
            <div
              ...
              className="bg-[#0D0D12] border border-[#E10600]/30 p-5 rounded-2xl shadow-[0_20px_50px_rgba(225,6,0,0.2)] max-w-[300px] cursor-pointer hover:border-[#E10600] transition-all relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 p-2 opacity-20 group-hover:opacity-100 transition-opacity">
                <Sparkles size={12} className="text-[#E10600]" />
              </div>
              <div className="flex items-start gap-4">
                <div className="size-12 rounded-full bg-[#E10600]/10 flex items-center justify-center flex-shrink-0 border border-[#E10600]/20">
                  <Cpu size={24} className="text-[#E10600]" />
                </div>
                <div className="space-y-1">
                  <p className="text-[10px] font-black text-[#E10600] uppercase tracking-widest">
                    FIKO™ INTELLIGENCE
                  </p>
      ...
      <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-[90] w-full max-w-md px-6">
        <button
          ...
          className="w-full bg-[#E10600] hover:bg-red-700 text-white py-5 rounded-full font-black text-xs uppercase tracking-[0.5em] shadow-[0_20px_60px_rgba(225,6,0,0.4)] hover:shadow-[0_20px_80px_rgba(225,6,0,0.6)] transition-all hover:scale-105 flex items-center justify-center gap-4 group"
        >
        ...
        {selectedOffer && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/95 backdrop-blur-xl p-6">
            <motion.div
              ...
              className="bg-[#0D0D12] border border-[#E10600]/30 p-10 lg:p-16 rounded-sm max-w-xl w-full relative shadow-[0_0_100px_rgba(225,6,0,0.15)]"
            >
              <button
                ...
                <div className="space-y-4">
                  {isProcessing ? (
                    <div className="flex flex-col items-center justify-center py-12 space-y-6">
                      <div className="size-16 border-4 border-[#E10600]/20 border-t-[#E10600] rounded-full animate-spin"></div>
                    ...
                    <>
                      <button
                        ...
                        className="w-full bg-white text-black py-6 rounded-sm font-black uppercase tracking-[0.3em] hover:bg-[#E10600] hover:text-white transition-all flex items-center justify-center gap-4 group"
                      >
                        <CreditCard
                          size={20}
        ...
        {upsellOffer && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/98 backdrop-blur-2xl p-6">
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.9, y: 30 }}
              className="bg-[#0D0D12] border border-[#E10600]/50 p-12 lg:p-20 rounded-sm max-w-2xl w-full relative shadow-[0_0_150px_rgba(225,6,0,0.3)] overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-64 h-64 bg-[#E10600] blur-[120px] opacity-10"></div>

              <div className="text-center space-y-10 relative z-10">
                <div className="size-20 bg-[#E10600]/10 rounded-full flex items-center justify-center mx-auto border border-[#E10600]/30">
                  <TrendingUp size={40} className="text-[#E10600]" />
                </div>

                <div className="space-y-4">
                  <h3 className="text-4xl lg:text-6xl font-black uppercase tracking-tighter text-[#E10600]">
                    NE SOYEZ PAS MOYEN.
                  </h3>
                ...
                <div className="bg-white/[0.02] border border-white/10 p-8 text-left space-y-6">
                  ...
                  <p className="text-xs text-[#E10600] font-black uppercase tracking-[0.3em] animate-pulse">
                ...
                <div className="space-y-4">
                  <button
                    ...
                    className="w-full bg-[#E10600] hover:bg-red-700 text-white py-6 rounded-sm font-black uppercase tracking-[0.3em] transition-all shadow-[0_20px_50px_rgba(225,6,0,0.3)]"
                  >
        ...
        {showPopup && (
          <div className="fixed inset-0 z-[150] flex items-center justify-center bg-black/90 backdrop-blur-md p-6">
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.9, y: 30 }}
              className="bg-[#0D0D12] border border-[#E10600]/30 p-12 rounded-sm max-w-md w-full relative shadow-[0_0_80px_rgba(225,6,0,0.2)]"
            >
              <button
              ...
              <div className="size-16 bg-[#E10600]/10 rounded-full flex items-center justify-center mb-8 border border-[#E10600]/30">
                <Cpu size={32} className="text-[#E10600]" />
              </div>
              <h3 className="text-3xl font-black uppercase tracking-tighter mb-4 text-[#E10600]">
              ...
              <button
                ...
                className="w-full bg-[#E10600] text-white py-5 rounded-sm font-black uppercase tracking-[0.3em] hover:bg-red-700 transition-all shadow-2xl"
              >
      ...
      <main className="relative z-10 pt-32 pb-40 px-6 max-w-7xl mx-auto">
        ...
        <section className="text-center mb-48">
          <motion.div
            ...
            className="inline-flex items-center gap-3 px-6 py-2.5 rounded-full bg-[#E10600]/10 border border-[#E10600]/30 text-[#E10600] text-[10px] font-black uppercase tracking-[0.5em] mb-12"
          >
            <span className="size-2 rounded-full bg-[#E10600] animate-pulse shadow-[0_0_10px_#E10600]"></span>
          ...
          >
            VOTRE SITE EST <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E10600] to-orange-600">
              UN CIMETIÈRE.
            </span>
          </motion.h1>
          ...
          >
            <button
              onClick={() => onNavigate(Page.FIKO_AUDIT)}
              className="w-full sm:w-auto bg-[#E10600] hover:bg-red-700 text-white px-12 py-8 rounded-sm font-black text-sm uppercase tracking-[0.5em] transition-all shadow-[0_20px_60px_rgba(225,6,0,0.3)] hover:shadow-[0_20px_80px_rgba(225,6,0,0.5)] hover:-translate-y-2 flex items-center justify-center gap-4"
            >
              <Zap size={20} />
              DÉPLOYER FIKO™
            </button>
            ...
            >
              <Mic size={20} className="text-[#E10600]" />
        ...
        <section className="mb-48">
          <div className="bg-[#0D0D12] border border-[#E10600]/20 rounded-sm p-12 lg:p-24 relative overflow-hidden shadow-2xl">
            <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-[#E10600]/5 to-transparent pointer-events-none"></div>

            <div className="grid lg:grid-cols-2 gap-24 items-center relative z-10">
              <div className="space-y-12">
                <h2 className="text-5xl lg:text-7xl font-black uppercase tracking-tighter leading-none">
                  L'HÉSITATION <br />
                  <span className="text-[#E10600]">TUE VOTRE ROI.</span>
                </h2>
                <div className="space-y-8 text-xl lg:text-2xl text-slate-400 font-light italic leading-tight">
                  <p className="flex items-start gap-6">
                    <span className="text-[#E10600] font-black text-4xl">
                      01.
                    </span>{" "}
                  ...
                  <div className="pt-10 border-t border-white/5">
                    <p className="text-[#E10600] font-black text-4xl lg:text-5xl uppercase tracking-tighter">
              ...
              <div className="relative aspect-square bg-black border border-white/5 rounded-sm flex flex-col items-center justify-center overflow-hidden group">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="size-64 border border-[#E10600]/20 rounded-full animate-ping opacity-30"></div>
                  <div className="size-96 border border-[#E10600]/10 rounded-full animate-[ping_5s_infinite] opacity-20"></div>
                </div>
                <div className="text-center z-10 space-y-6">
                  <Users
                    size={80}
                    className="text-slate-800 mx-auto group-hover:text-[#E10600]/40 transition-colors duration-700"
                  />
                  <div className="font-mono text-[10px] text-slate-600 tracking-[0.4em] uppercase">
                    SYSTEM_LOG: VISITOR_EXIT_TIMEOUT
                  </div>
                  <p className="text-[#E10600] font-black text-6xl tracking-tighter animate-pulse">
                    -1 VENTE
                  </p>
                </div>
              </div>
        ...
        <section className="mb-48 text-center space-y-12">
          <h2 className="text-5xl lg:text-8xl font-black uppercase tracking-tighter leading-none">
            ...
            <span className="text-[#E10600] italic underline decoration-white/10">
        ...
        <section className="mb-48 grid lg:grid-cols-2 gap-10">
          ...
          <div className="bg-gradient-to-br from-[#E10600]/20 to-[#0D0D12] border border-[#E10600]/30 p-16 rounded-sm space-y-10 relative overflow-hidden group">
            <div className="absolute -right-20 -top-20 size-64 bg-[#E10600] blur-[100px] opacity-20 group-hover:opacity-40 transition-opacity duration-1000"></div>
            <h3 className="text-3xl font-black uppercase tracking-widest text-[#E10600]">
              FiKO™ AI (Illimité)
            </h3>
            <div className="space-y-4">
              <p className="text-7xl font-black text-white">
            ...
            <div className="pt-10 border-t border-white/10 flex items-center gap-4 text-[10px] font-black text-[#E10600] uppercase tracking-widest">
          ...
          <div className="max-w-4xl mx-auto bg-[#0D0D12] border border-white/10 rounded-sm overflow-hidden shadow-2xl">
            <div className="bg-white/5 px-8 py-5 border-b border-white/10 flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="size-3 rounded-full bg-[#E10600] animate-pulse shadow-[0_0_10px_#E10600]"></div>
            ...
            <div className="p-10 lg:p-16 space-y-8 min-h-[500px] flex flex-col justify-end">
              <AnimatePresence mode="popLayout">
                {chatMessages.slice(0, chatStep + 1).map((msg, idx) => (
                  ...
                  >
                    <div
                      className={`max-w-[85%] p-6 rounded-sm ${msg.sender === "client" ? "bg-white/5 text-slate-300 border border-white/5" : "bg-[#E10600]/10 border border-[#E10600]/30 text-white"}`}
                    >
                      {msg.sender === "fiko" && (
                        <div className="text-[9px] font-black text-[#E10600] uppercase tracking-widest mb-2 flex items-center gap-2">
              ...
              {chatStep < 4 && (
                <div className="flex justify-start">
                  <div className="bg-white/5 p-5 rounded-sm flex gap-3 items-center border border-white/5">
                    <span className="size-1.5 bg-[#E10600] rounded-full animate-bounce"></span>
                    <span className="size-1.5 bg-[#E10600] rounded-full animate-bounce [animation-delay:0.2s]"></span>
                    <span className="size-1.5 bg-[#E10600] rounded-full animate-bounce [animation-delay:0.4s]"></span>
                  </div>
                </div>
              )}
            </div>
        ...
        <section className="mb-48">
          <div className="text-center mb-24 space-y-6">
            <h2 className="text-5xl lg:text-7xl font-black uppercase tracking-tighter">
              L'ÉCOSYSTÈME <span className="text-[#E10600]">FIKO™</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="bg-[#0D0D12] border border-white/5 p-12 rounded-sm hover:border-[#E10600]/40 transition-all group relative overflow-hidden"
              >
                <div className="absolute -right-10 -bottom-10 size-32 bg-[#E10600] blur-[80px] opacity-0 group-hover:opacity-10 transition-opacity"></div>
                <mod.icon
                  size={40}
                  className="text-[#E10600] mb-8 group-hover:scale-110 transition-transform duration-500"
                />
                <h3 className="text-2xl font-black uppercase tracking-tight mb-4 group-hover:text-[#E10600] transition-colors">
                  {mod.title}
                </h3>
        ...
        <section className="mb-48">
          <div className="text-center mb-24 space-y-6">
            <h2 className="text-5xl lg:text-8xl font-black uppercase tracking-tighter leading-none">
              RECRUTEZ VOTRE <br />
              <span className="text-[#E10600]">UNITÉ IA.</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 items-stretch">
            {/* SOLO */}
            <div className="bg-[#0D0D12] border border-white/5 p-10 rounded-sm flex flex-col hover:border-[#E10600]/30 transition-all group">
              <div className="mb-10">
                <h3 className="text-3xl font-black uppercase tracking-tighter mb-2">
                  🌍 SOLO
                </h3>
                <p className="text-3xl font-black text-[#E10600]">
                  30 000{" "}
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-4 text-sm text-slate-400 font-medium italic">
                      <CheckCircle2
                        size={16}
                        className="text-[#E10600] flex-shrink-0 mt-0.5"
                      />{" "}
                      Réponse auto 24/7
                    </li>
                    <li className="flex items-start gap-4 text-sm text-slate-400 font-medium italic">
              ...
              <button
                onClick={() => handleOfferClick("TERRA")}
                className="w-full mt-10 bg-white/5 hover:bg-[#E10600] text-white py-5 rounded-sm font-black uppercase tracking-[0.3em] transition-all text-xs"
              >
                ACTIVER SOLO
              </button>
            </div>
            ...
            {/* PILOT */}
            <div className="bg-[#0D0D12] border-2 border-[#E10600]/50 p-10 rounded-sm flex flex-col relative transform lg:-translate-y-6 shadow-[0_30px_100px_rgba(225,6,0,0.15)]">
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#E10600] text-white text-[9px] font-black uppercase tracking-[0.4em] px-6 py-2 rounded-full shadow-xl">
                RECOMMANDÉ
              </div>
              <div className="mb-10">
                <h3 className="text-3xl font-black uppercase tracking-tighter mb-2">
              ...
              <div className="space-y-8 flex-grow">
                ...
                <div className="p-6 bg-[#E10600]/5 border border-[#E10600]/20 space-y-3">
                  <p className="text-[9px] font-black text-[#E10600] uppercase tracking-widest">
                    ROI ESTIMÉ :
                  </p>
                  <p className="text-lg font-black text-white italic">
              ...
              <button
                onClick={() => handleOfferClick("MARS")}
                className="w-full mt-10 bg-[#E10600] hover:bg-red-700 text-white py-6 rounded-sm font-black uppercase tracking-[0.3em] transition-all text-xs shadow-2xl"
              >
                ACTIVER PILOT
              </button>
            </div>
            ...
            <div className="bg-[#0D0D12] border border-white/5 p-10 rounded-sm flex flex-col hover:border-[#E10600]/30 transition-all group">
              ...
              <button
                onClick={() => handleOfferClick("KRYPTON")}
                className="w-full mt-10 bg-white/5 hover:bg-[#E10600] text-white py-5 rounded-sm font-black uppercase tracking-[0.3em] transition-all text-xs"
              >
                ACTIVER ELITE
              </button>
            ...
            {/* EMPIRE */}
            <div className="bg-gradient-to-b from-[#1A0505] to-[#0D0D12] border border-[#E10600]/30 p-10 rounded-sm flex flex-col relative overflow-hidden">
              <div className="absolute top-0 right-0 size-32 bg-[#E10600] blur-[60px] opacity-10"></div>
              <div className="mb-10">
                <h3 className="text-3xl font-black uppercase tracking-tighter mb-2">
                  🌌 EMPIRE
                </h3>
              ...
              <div className="space-y-8 flex-grow">
                ...
                <div className="p-6 bg-[#E10600]/10 border border-[#E10600]/30 space-y-3">
                  <p className="text-[9px] font-black text-[#E10600] uppercase tracking-widest">
                    ROI ESTIMÉ :
                  </p>
                  <p className="text-lg font-black text-white italic">
              ...
              <button
                onClick={() => handleOfferClick("GALAXY")}
        ...
        <section className="mb-48">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center space-y-4 p-12 border-r border-white/5 last:border-0">
              <TrendingUp size={48} className="text-[#E10600] mx-auto mb-6" />
            ...
            <div className="text-center space-y-4 p-12 border-r border-white/5 last:border-0">
              <Target size={48} className="text-[#E10600] mx-auto mb-6" />
            ...
            <div className="text-center space-y-4 p-12">
              <Clock size={48} className="text-[#E10600] mx-auto mb-6" />
        ...
        {/* FINAL CTA */}
        <section className="text-center bg-[#E10600]/5 border border-[#E10600]/20 p-16 lg:p-32 rounded-sm relative overflow-hidden">
          <div className="absolute inset-0 hex-bg opacity-10 pointer-events-none"></div>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-[600px] bg-[#E10600]/10 blur-[150px] rounded-full pointer-events-none"></div>

          <div className="max-w-4xl mx-auto relative z-10 space-y-12">
            <h2 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none">
              UN HUMAIN TRAITE 1 CLIENT.
              <br />
              <span className="text-[#E10600]">FiKO™ EN TRAITE 1000.</span>
            </h2>
            <div className="w-32 h-1.5 bg-[#E10600] mx-auto"></div>
            <p className="text-2xl lg:text-3xl text-slate-300 font-light italic leading-relaxed">
              ...
              <strong className="text-white underline decoration-[#E10600]">
            ...
            <button
              onClick={() => onNavigate(Page.FIKO_AUDIT)}
              className="inline-flex items-center justify-center gap-6 bg-[#E10600] hover:bg-red-700 text-white px-16 py-10 rounded-sm font-black text-xl uppercase tracking-[0.5em] transition-all shadow-[0_30px_100px_rgba(225,6,0,0.4)] hover:scale-105 active:scale-95"
            >
        ...
        {showSuccessScreen && (
          <div className="fixed inset-0 z-[300] bg-[#050505] flex flex-col items-center justify-center p-6 text-center overflow-y-auto">
            <div className="absolute inset-0 bg-gradient-to-t from-[#E10600]/20 to-transparent pointer-events-none"></div>

            <motion.div
              initial={{ scale: 0.8, opacity: 0, y: 50 }}
              animate={{ scale: 1, opacity: 1, y: 0 }}
              className="relative z-10 max-w-2xl w-full bg-[#0D0D12] border border-[#E10600]/50 p-12 lg:p-20 rounded-sm shadow-[0_0_150px_rgba(225,6,0,0.3)]"
            >
              ...
              <h1 className="text-5xl lg:text-7xl font-black uppercase tracking-tighter mb-6">
                UNITÉ <span className="text-[#E10600]">ACTIVÉE</span>
              </h1>
              ...
              <div className="bg-white/[0.02] border border-white/5 p-8 rounded-sm mb-12 text-left space-y-6">
                <h3 className="text-[#E10600] font-black uppercase tracking-[0.3em] mb-4">
                  PROTOCOLE DE DÉPLOIEMENT :
                </h3>
                <ul className="space-y-4">
                  <li className="flex items-center gap-6 text-slate-300 font-bold italic">
                    <span className="size-10 rounded-full bg-[#E10600]/10 flex items-center justify-center text-[#E10600] flex-shrink-0 font-black">
                      1
                    </span>{" "}
              ...
              <button
                ...
                className="w-full bg-[#E10600] hover:bg-red-700 text-white py-6 rounded-sm font-black text-xl uppercase tracking-[0.4em] transition-all shadow-[0_30px_80px_rgba(225,6,0,0.4)]"
              >
                ACCÉDER AU SYSTÈME
              </button>
            </motion.div>
