...
const WhitepaperPage: React.FC<WhitepaperPageProps> = ({ onNavigate }) => {
  return (
    <div className="bg-[#0B0B0F] min-h-screen text-white selection:bg-[#FF2718]">
      {/* Background elements */}
      <div className="fixed inset-0 hex-bg opacity-[0.03] pointer-events-none"></div>
      <div className="fixed top-0 left-0 w-full h-full bg-gradient-to-b from-[#FF2718]/5 to-transparent pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-32 pb-40 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-12 mb-24">
          <div className="space-y-6">
            ...
            <h1 className="text-6xl md:text-9xl font-black uppercase tracking-tighter leading-[0.8]">
              ARCHITECTING <br />
              <span className="text-[#FF2718]">DOMINATION.</span>
            </h1>
            <p className="text-2xl text-slate-400 font-light italic tracking-widest max-w-3xl border-l-2 border-[#FF2718] pl-10">
              L'infrastructure GCP qui propulse FIKO™ au sommet de l'efficacité
              commerciale.
            </p>
          </div>
          <button className="px-12 py-8 bg-[#FF2718] text-white text-[11px] font-black uppercase tracking-widest flex items-center gap-4 hover:scale-105 transition-transform shadow-[0_20px_50px_rgba(255,39,24,0.3)]">
              ...
              <div className="min-w-[1000px] flex flex-col gap-24 relative">
                ...
                <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-20">
                  {[...Array(5)].map((_, i) => (
                    <div
                      key={i}
                      className={`absolute h-px bg-gradient-to-r from-transparent via-[#FF2718] to-transparent w-full animate-data-flow`}
                      style={{
                        top: `${20 * i}%`,
                ...
                <div className="bg-[#1A1A1F] border border-white/10 p-12 relative overflow-hidden">
                  ...
                  <div className="mb-10 flex justify-between items-center">
                    <span className="text-[10px] font-black uppercase tracking-[0.5em] text-[#FF2718]">
                  ...
                  <div className="grid grid-cols-3 gap-8">
                    ...
                    <div className="p-6 bg-black/40 border border-white/5 text-center space-y-3">
                      ...
                      <Mic className="mx-auto text-[#FF2718]" size={24} />
                    </div>
                    <div className="p-6 bg-black/40 border border-white/5 text-center space-y-3">
                      <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest">
                        MINI CRM / BI
                ...
                <div className="grid grid-cols-2 gap-12">
                  <div className="bg-black border border-[#FF2718]/30 p-12 relative">
                    <div className="absolute -top-4 -left-4 size-12 bg-[#FF2718] flex items-center justify-center text-white shadow-2xl">
                      <Zap size={24} />
                    </div>
                    <span className="text-[10px] font-black uppercase tracking-[0.5em] text-[#FF2718] block mb-8">
                    ...
                    <div className="space-y-4 font-mono text-[10px] text-slate-500">
                      ...
                      <p className="flex justify-between border-b border-white/5 pb-2">
                        ...
                        <span className="text-[#FF2718]">ACTIVE</span>
                      </p>
                ...
                {/* LAYER 4: DATA & BI */}
                <div className="grid grid-cols-3 gap-8">
                  <div className="bg-[#1A1A1F] p-8 border border-white/5 text-center group hover:border-[#FF2718]/30 transition-all">
                    <Database className="mx-auto mb-4 text-slate-500 group-hover:text-[#FF2718]" />
                  ...
                  <div className="bg-[#FF2718] p-8 text-center shadow-2xl">
        ...
        <section className="space-y-12">
          <h2 className="text-4xl font-black uppercase tracking-tighter flex items-center gap-6">
            <div className="size-12 bg-[#FF2718]/10 border border-[#FF2718]/30 flex items-center justify-center text-[#FF2718]">
              <Bot size={24} />
            </div>
              ...
              {[
                {
                  ...
                  icon: <Globe className="text-[#FF2718]" />,
                },
                {
                  title: "API GATEWAY",
                ...
                },
                {
                  ...
                  icon: <Database className="text-[#FF2718]" />,
                },
                {
                  title: "IA CORE",
                  desc: "Vertex AI (GCP). Inférence multimodale via Gemini 1.5 Pro & Flash avec monitoring de drift.",
                  icon: <Cpu className="text-[#FF2718]" />,
                },
              ].map((item, i) => (
                <div key={i} className="flex gap-10 group">
                  <div className="flex-shrink-0 size-16 bg-black border border-white/10 flex items-center justify-center group-hover:border-[#FF2718]/40 transition-all">
                    {item.icon}
                  </div>
        ...
        <div className="mt-40 pt-20 border-t border-white/5 text-center">
          <h3 className="text-3xl font-black uppercase tracking-tighter mb-10">
            PRÊT POUR LA <span className="text-[#FF2718]">DISRUPTION ?</span>
          </h3>
          <button
            onClick={() => onNavigate(Page.AUTH)}
            className="bg-[#FF2718] hover:bg-red-700 text-white px-16 py-8 rounded-sm font-black text-sm uppercase tracking-[0.4em] transition-all shadow-2xl active:scale-95"
          >
...
const ArrowDownIcon = () => (
  <div className="flex flex-col items-center gap-1 opacity-20">
    <div className="w-px h-12 bg-gradient-to-b from-[#FF2718] to-transparent"></div>
    <ChevronDown size={14} className="text-[#FF2718]" />
  </div>
);
