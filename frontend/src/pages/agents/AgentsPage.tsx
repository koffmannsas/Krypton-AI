...
`,
      ...
      let errorMessage = error.message || "Une erreur est survenue lors de la génération.";
      if (error?.status === 429 || error?.toString().includes("RESOURCE_EXHAUSTED")) {
         errorMessage = "Quota IA épuisé. Veuillez recharger vos crédits API sur Google AI Studio.";
      }
