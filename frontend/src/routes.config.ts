...
export const ROUTES: Record<Page, RouteConfig> = {
  ...
  [Page.PROFILE]: {
    path: '/profil',
    enum: Page.PROFILE,
    title: 'Profil Utilisateur | Espace Membre Krypton',
    description: 'Gérez vos informations personnelles et professionnelles et consultez l\'état de votre infrastructure.',
  },
  [Page.ADMIN_AUTH]: {
    path: '/admin/auth',
  ...
  [Page.DATA_DELETION]: {
    path: '/data-deletion',
    enum: Page.DATA_DELETION,
    title: 'Suppression des données | Krypton AI',
    description: 'Procédure pour demander la suppression de vos données personnelles sur Krypton AI et Fiko Connect.',
  },
  [Page.TERMS]: {
    path: '/terms',
    enum: Page.TERMS,
  ...
  [Page.AUTH_CALLBACK]: {
    path: '/auth/callback',
    enum: Page.AUTH_CALLBACK,
    title: 'Authentification | Krypton AI',
    description: 'Callback d\'authentification.',
  },
  [Page.AMBASSADEURS]: {
    path: '/ambassadeurs',
    enum: Page.AMBASSADEURS,
    title: 'Ambassadeurs | Krypton AI',
    description: 'Rejoignez le programme Partenaire Élite Krypton AI.',
  },
  [Page.ASSISTANCE]: {
    path: '/assistance',
    enum: Page.ASSISTANCE,
    title: 'Centre Assistance | Krypton AI',
    description: 'Fiko Assistant vous aide à comprendre, configurer et exploiter toute la puissance de Krypton AI.',
  },
  [Page.ASSISTANCE_TOPIC]: {
    path: '/assistance/:slug',
    enum: Page.ASSISTANCE_TOPIC,
    title: 'Assistance Krypton AI | %s',
    description: 'Guide et solution Fiko Assistant pour votre projet de %s.',
  },
  [Page.ABOUT]: {
    path: '/about',
    enum: Page.ABOUT,
    title: 'Qui sommes-nous | KOFFMANN CAPITAL GROUP',
    description: 'Découvrez la vision et la mission de Koffmann Capital Group, bâtisseur d\'infrastructure technologique africaine.',
  },
  [Page.PORTAL_ACTIVATION]: {
    path: '/activation',
    enum: Page.PORTAL_ACTIVATION,
    title: 'Activation d\'Infrastructure | Krypton AI',
    description: 'Initialisation de votre environnement et moteur IA.',
  },
  [Page.FIKO_SEND]: {
    path: '/fiko-send',
    enum: Page.FIKO_SEND,
    title: 'FIKO SEND | Marketing SMS & Emailing unifié',
    description: 'La première plateforme unifiée SMS & Emailing conçue en Afrique.',
  },
  [Page.EGERIE]: {
    path: '/egerie',
    enum: Page.EGERIE,
    title: 'FIKO ÉGÉRIE | L\'Élite Mondiale du Prestige Digital',
    description: 'Rejoignez l\'écosystème exclusif des leaders culturels, entrepreneurs et icônes du réseau FIKO.',
  },
};
