...
const Footer: React.FC = () => {
  return (
    <footer className="py-24 px-6 border-t border-white/5 bg-[#0B0B0F]">
      <div className="max-w-7xl mx-auto grid md:grid-cols-5 md:gap-8 lg:gap-16 mb-24">
          ...
          <ul className="flex flex-col gap-5 text-[10px] uppercase tracking-[0.2em] text-slate-500 font-bold">
            <li>
              <a
                ...
                className="hover:text-[#FF2718] transition-colors text-left flex items-center gap-2"
              >
            ...
            <li>
              <Link
                to={ROUTES[Page.DATA_DELETION].path}
                className="hover:text-[#FF2718] transition-colors text-left"
              >
            ...
            <li>
              <Link
                to={ROUTES[Page.TERMS].path}
                className="hover:text-[#FF2718] transition-colors text-left"
              >
                Conditions d'utilisation
              </Link>
            </li>
            {/* You can add more useful links here in the future */}
          </ul>
        </div>
